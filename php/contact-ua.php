...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($agree != 'on') {
        array_push($data_error, "Ви повинні погодитися з умовами");
    }
...
//    }
        ...
        if ($telegramResponse && json_decode($telegramResponse)->ok) {
            ...
            http_response_code(200);
            header('Content-Type: application/json');
            echo json_encode(['status' => 'ok', 'data' => 'Дякую вам! Ваше повідомлення успішно надіслано. Наші менеджери зв'."'".'яжуться з Вами.']);
            exit();
        } else {
